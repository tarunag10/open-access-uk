...
const BENEFIT_TYPES = [
  ...
  },
  {
    ...
    mrDeadlineMonths: 1,
    tribunalDeadlineMonths: 1,
    source: 'govuk-uc-mandatory-reconsideration'
  },
  {
    id: 'esa',
...
const PIP_DESCRIPTORS = [
  ...
  },
  {
    category: 'mobility',
    label: 'Mobility',
    activities: ['Planning and following journeys', 'Moving around']
  }
];

const ESA_DESCRIPTORS = [
  {
    category: 'coping_with_physical_demands',
    label: 'Coping with physical demands',
    activities: [
      'Mobilising',
  ...
  {
    category: 'coping_with_social_demands',
    label: 'Coping with social demands',
    activities: [
      'Understanding communication',
      'Engaging in social engagement',
      'Coping with social engagement',
      'Appropriateness of behaviour'
    ]
  },
  {
    category: 'coping_with_unpredictable_situations',
    label: 'Coping with unpredictable situations',
    activities: ['Awareness of danger', 'Adapting to change', 'Getting about safely']
  }
];
...
function getDescriptorGuidance(benefitType) {
  switch (benefitType) {
    case 'pip':
      return [...PIP_DESCRIPTORS];
    case 'esa':
      return [...ESA_DESCRIPTORS];
    case 'uc':
      return [...UC_DESCRIPTORS];
    default:
      return [];
  }
}
